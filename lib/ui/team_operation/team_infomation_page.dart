...
class TeamInformationPage extends StatelessWidget {
  TeamData teamData;

  TeamInformationPage({super.key, required this.teamData});
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              IconText(
                  text: teamData.level, iconAsset: "assets/ic_info_level.png"),
              const SizedBox(height: 8),
              const Divider(),
              const SizedBox(height: 8),
              ReviewRating(
